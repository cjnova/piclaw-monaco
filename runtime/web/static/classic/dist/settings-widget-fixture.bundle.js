...
`).map((r)=>r.trim()).filter(Boolean)}function ol({recording:n,details:r,onDelete:i,onRefresh:_}){if(!n)return l`<div class="settings-task-detail-empty">Select a recording to inspect, replay, export, or delete it.</div>`;let c=r?.meta||n,u=Array.isArray(r?.events)?r.events:[],f=u.reduce((s,$)=>s+(Array.isArray($.redactions)?$.redactions.length:0),0),o=u.reduce((s,$)=>{let b=$.kind||"event";return s[b]=(s[b]||0)+1,s},{});return l`
        <div class="settings-task-detail settings-recording-detail">
            <div class="settings-task-detail-header">
                ...
                <div class="settings-task-detail-actions">
                    <button onClick=${()=>window.open(xi(c.id),"_blank","noopener,noreferrer")}>Playback</button>
    ...
    `}function sl({filter:n="",setStatus:r}){let[i,_]=w([]),[c,u]=w([]),[f,o]=w(!0),[s,$]=w(null),[b,g]=w(null),[p,x]=w(null),[v,F]=w(!1),[y,K]=w(ll),[W,N]=w(""),[B,U]=w("redacted"),[z,j]=w(!0),[X,t]=w(""),[H,k]=w(""),[h,L]=w('{"Authorization":"Bearer abc1234567890","content":"hello"}'),[Q,C]=w(null);P(()=>{let G=(d)=>{let cn=String(d?.detail?.chatJid||"").trim();if(cn)K(cn)};return window.addEventListener("piclaw:current-chat-changed",G),()=>window.removeEventListener("piclaw:current-chat-changed",G)},[]);let O=T(async(G=b)=>{o(!0),$(null);try{let d=await wi(),cn=d.recordings||[];_(cn),u(d.active||[]);let Bn=cn.find((R)=>R.id===G)||cn[0]||null;if(g(Bn?.id||null),Bn?.id)x(await Tr(Bn.id));else x(null)}catch(d){$(d?.message||"Failed to load recordings.")}finally{o(!1)}},[b]);P(()=>{O()},[O]);let gn=D(()=>i.find((G)=>G.id===b)||null,[i,b]),a=D(()=>c.find((G)=>G.chatJid===y)||null,[c,y]),un=String(n||"").trim().toLowerCase(),ln=D(()=>{if(!un)return i;return i.filter((G)=>[G.id,G.title,G.chatJid,G.status,G.mode].some((d)=>String(d||"").toLowerCase().includes(un)))},[i,un]),wn=T(async(G)=>{if(g(G?.id||null),x(null),!G?.id)return;try{x(await Tr(G.id))}catch(d){r?.(d?.message||"Failed to load recording.","error")}},[r]),I=T(async()=>{if(v)return;F(!0);try{let G={keys:lr(X),patterns:lr(H)},d=await ti({chat_jid:y,title:W||void 0,mode:B,include_timeline_snapshot:z,timeline_snapshot_limit:80,redaction:G});r?.(`Recording started for ${y}.`,"success"),await O(d?.recording?.id)}catch(G){r?.(G?.message||"Failed to start recording.","error")}finally{F(!1)}},[v,y,X,H,z,O,B,r,W]),V=T(async(G=a)=>{if(!G||v)return;F(!0);try{let d=await yi({id:G.id});r?.(`Recording stopped for ${G.chatJid}.`,"success"),await O(d?.recording?.id)}catch(d){r?.(d?.message||"Failed to stop recording.","error")}finally{F(!1)}},[v,a,O,r]),q=T(async(G)=>{if(!G||v)return;if(!window.confirm(`Delete recording ${G.id}?

${G.title||""}`))return;F(!0);try{await hi(G.id),r?.("Recording deleted.","success"),await O(null)}catch(d){r?.(d?.message||"Failed to delete recording.","error")}finally{F(!1)}},[v,O,r]),yn=T(async()=>{try{let G=JSON.parse(h||"null"),d=await vi(G,{mode:B,redaction:{keys:lr(X),patterns:lr(H)}});C(d.preview)}catch(G){C({error:G?.message||"Preview failed."})}},[X,H,B,h]);return l`
        <div class="settings-section settings-recordings-section">
            ...
            <details class="settings-recording-preview">
                ...
                <textarea rows="4" value=${h} onInput=${(G)=>L(G.target.value)} />
    ...
    `}var hc=Y(()=>{m();tc()});function bc(n,r=Vi){let i=Number(n);if(!Number.isFinite(i))return r;return Math.min(300,Math.max(15,Math.round(i)))}function pc(n,r=Pi){let i=Number(n);if(!Number.isFinite(i))return r;return Math.min(8,Math.max(0,Math.round(i)))}function Xi(){return{refreshIntervalSec:bc(ji(xc,Vi),Vi),folderPreviewDepth:pc(ji(vc,Pi),Pi)}}function Kc(n={}){let r=Xi(),i={refreshIntervalSec:bc(Object.prototype.hasOwnProperty.call(n,"refreshIntervalSec")?n.refreshIntervalSec:r.refreshIntervalSec,r.refreshIntervalSec),folderPreviewDepth:pc(Object.prototype.hasOwnProperty.call(n,"folderPreviewDepth")?n.folderPreviewDepth:r.folderPreviewDepth,r.folderPreviewDepth)};if(fn(xc,String(i.refreshIntervalSec)),fn(vc,String(i.folderPreviewDepth)),typeof window<"u")window.dispatchEvent(new CustomEvent(Fl,{detail:{settings:i}}));return i}var Fl="piclaw:workspace-client-settings-updated",xc="workspaceRefreshIntervalSec",vc="workspaceFolderPreviewDepth",Vi=60,Pi=3;var zc=()=>{};var Bc={};_n(Bc,{WorkspaceSection:()=>Bl});function Fc(n={}){let r=n.workspaceSettings||{};return{webTerminalEnabled:r.webTerminalEnabled!==!1,vncAllowDirect:r.vncAllowDirect!==!1,treeMaxDepth:r.treeMaxDepth??4,treeMaxEntries:r.treeMaxEntries??5000}}function Bl({settingsData:n,setStatus:r,mergeSettingsData:i}){let[_,c]=w(!0),[u,f]=w(!0),[o,s]=w(4),[$,b]=w(5000),[g,p]=w(60),[x,v]=w(3),[F,y]=w(!1),[K,W]=w(!1),N=Z(""),B=Z(null),U=Z(null),z=Z(null),j=Z(!0);P(()=>{return j.current=!0,()=>{if(j.current=!1,B.current)clearTimeout(B.current);if(U.current)clearTimeout(U.current);if(z.current)clearTimeout(z.current)}},[]);let X=T((k)=>{let h=Fc(k),L=Xi();c(h.webTerminalEnabled),f(h.vncAllowDirect),s(h.treeMaxDepth),b(h.treeMaxEntries),p(L.refreshIntervalSec),v(L.folderPreviewDepth),N.current=JSON.stringify(h)},[]);P(()=>{X(n||{})},[n,X]);let t=D(()=>JSON.stringify(Fc({workspaceSettings:{webTerminalEnabled:_,vncAllowDirect:u,treeMaxDepth:o,treeMaxEntries:$}})),[_,u,o,$]);P(()=>{if(t===N.current)return;if(B.current)clearTimeout(B.current);return B.current=setTimeout(async()=>{if(!j.current)return;let k=document.activeElement;if(k&&k.closest?.(".settings-number-stepper"))return;try{let h=await Fi(JSON.parse(t));if(!j.current||!h?.ok||!h?.settings)return;if(N.current=t,i?.({workspaceSettings:h.settings}),r?.(null),y(!0),U.current)clearTimeout(U.current);U.current=setTimeout(()=>{if(j.current)y(!1)},4000)}catch(h){r?.(String(h?.message||h),"error")}},800),()=>{if(B.current)clearTimeout(B.current)}},[t,i,r]);let H=T((k)=>{let h=Kc(k);if(p(h.refreshIntervalSec),v(h.folderPreviewDepth),W(!0),z.current)clearTimeout(z.current);z.current=setTimeout(()=>{if(j.current)W(!1)},3000)},[]);return l`
        <div class="settings-section">
            ${F&&l`
                <div class="settings-general-applied-notice" role="status" aria-live="polite">
    ...
    `}var kc=Y(()=>{m();Kn();zc();Cn()});var Wc={};_n(Wc,{EnvironmentSection:()=>kl});function Qi(n={}){let r=n.environmentSettings||n.settings||n.environment||{};return{variables:Array.isArray(r.variables)?r.variables:[],overrides:r.overrides&&typeof r.overrides==="object"?r.overrides:{},count:Number(r.count||0),overrideCount:Number(r.overrideCount||0),keychainEnvNames:Array.isArray(r.keychainEnvNames)?r.keychainEnvNames:[]}}function kl({settingsData:n,filter:r="",setStatus:i,mergeSettingsData:_}){let[c,u]=w(()=>Qi(n||{})),[f,o]=w({}),[s,$]=w(""),[b,g]=w(""),[p,x]=w(null);P(()=>{u(Qi(n||{})),o({})},[n]);let v=T((B)=>{let U=Qi({environmentSettings:B?.settings||B});return u(U),_?.({environmentSettings:U}),o({}),U},[_]),F=T(async()=>{try{let B=await Bi();if(B?.ok)v(B.settings);i?.("Environment refreshed.","info")}catch(B){i?.(String(B?.message||B),"error")}},[v,i]),y=T(async(B,U)=>{let z=String(B||"").trim();if(!z)return;x(z);try{let j=await Ur({action:"set",name:z,value:String(U??"")});if(j?.ok)v(j.settings);if(i?.(`Saved environment override for ${z}.`,"info"),z===s.trim())$(""),g("")}catch(j){i?.(String(j?.message||j),"error")}finally{x(null)}},[v,s,i]),K=T(async(B)=>{let U=String(B||"").trim();if(!U)return;x(U);try{let z=await Ur({action:"clear",name:U});if(z?.ok)v(z.settings);i?.(`Cleared environment override for ${U}.`,"info")}catch(z){i?.(String(z?.message||z),"error")}finally{x(null)}},[v,i]),W=D(()=>{let B=String(r||"").trim().toLowerCase(),U=Array.isArray(c.variables)?c.variables:[];if(!B)return U;return U.filter((z)=>{return`${z?.name||""} ${z?.value||""} ${z?.source||""}`.toLowerCase().includes(B)})},[c.variables,r]),N=T((B,U)=>{o((z)=>({...z||{},[B]:U}))},[]);return l`
        <div class="settings-section">
    ...
    `}function Ll({filter:n=""}){let[r,i]=w(null),[_,c]=w(!1),[u,f]=w("off"),[o,s]=w(!1),[$,b]=w(["off"]),[g,p]=w(!1),[x,v]=w(!1),[F,y]=w(!1),K=T(async()=>{let k=await ki();if(i(k),k.thinking_level)f(k.thinking_level);if(s(Boolean(k.supports_thinking)),p(Boolean(k.scoped_models_only)),Array.isArray(k.available_thinking_levels)&&k.available_thinking_levels.length>0)b(k.available_thinking_levels);return k},[]);P(()=>{K().catch((k)=>{console.warn("[settings/models] Failed to load models.",k),i({models:[],model_options:[]})})},[]);let W=T(async(k)=>{if(_)return;c(!0);try{await pn("default",`/model ${k}`,null,[]),await K()}catch(h){console.error("Failed to switch model:",h)}finally{c(!1)}},[_,K]),N=T(async(k)=>{if(x)return;v(!0),p(Boolean(k));try{let h=await fetch("/agent/settings/general",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({scopedModelsOnly:Boolean(k)})}),L=await h.json().catch(()=>({}));if(!h.ok||!L?.ok)throw Error(L?.error||"Failed to save scoped model setting.");await K()}catch(h){console.error("Failed to set scoped model filtering:",h),await K().catch((L)=>{console.warn("[settings/models] Reload after scoped model filtering failure failed.",L)})}finally{v(!1)}},[x,K]),B=T(async(k)=>{if(F)return;y(!0),f(k);try{let h=await pn("default",`/thinking ${k}`,null,[]);if(h?.command?.thinking_level)f(h.command.thinking_level);s(h?.command?.supports_thinking!==!1),await K()}catch(h){console.error("Failed to set thinking:",h),await K().catch((L)=>{console.warn("[settings/models] Reload after thinking change failure failed.",L)})}finally{y(!1)}},[F,K]);if(!r)return l`<div class="settings-loading">Loading models\u2026</div>`;let U=r.model_options||[],z=r.current,X=U.find((k)=>k.label===z)?.provider||"",t=n.toLowerCase(),H=t?U.filter((k)=>k.label.toLowerCase().includes(t)||(k.provider||"").toLowerCase().includes(t)):U;return l`
            ...
            <div class="settings-row" style="padding:0 0 10px 0; align-items:flex-start">
                ...
                <div style="display:flex; flex-direction:column; gap:4px; min-width:0">
                    <label style="display:flex; align-items:center; gap:8px; font-weight:500">
                        <input type="checkbox" checked=${g} disabled=${x} onChange=${(k)=>N(k.target.checked)} />
...
${h}`;if(!window.confirm(L))return;if(k&&!window.confirm(`Task ${H.id} is internal/protected. Continue with ${t}?`))return;N(!0),r?.(`${t==="delete"?"Deleting":t==="pause"?"Pausing":"Resuming"} ${H.id}…`,"info");try{await $i(t,H.id,{allowInternal:k}),r?.(`Scheduled task ${H.id} ${t==="delete"?"deleted":t==="pause"?"paused":"resumed"}.`,"success"),await B({selectedId:t==="delete"?null:H.id})}catch(Q){r?.(Q?.message||`Failed to ${t} task.`,"error")}finally{N(!1)}},[W,B,r]);return l`
                            ...
                            <tr class="settings-keychain-notes-row" key=${R.name+"-notes"}>
                                <td colspan="5">
                                    <div style="display:grid; grid-template-columns:1fr 1fr auto; gap:8px; align-items:start; padding:8px 0 10px 0;">
                                        ...
                                        <button class="settings-keychain-save-btn" style="margin-top:20px" disabled=${!hu||n_} onClick=${()=>wn(R)}>
    ...
    `}var f0,l0,o0,s0;var iu=Y(()=>{m();f0={core:l`<svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><rect x="3.5" y="5" width="17" height="14" rx="2"/><path d="M7.5 10l2.5 2-2.5 2"/><path d="M12.5 15H16"/></svg>`,discovery:l`<svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><path d="M21 21l-4.35-4.35"/></svg>`,attachments:l`<svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M21.44 11.05l-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48"/></svg>`,"model-control":l`<svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="4" width="16" height="16" rx="2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/><path d="M9 15c.83.67 2 1 3 1s2.17-.33 3-1"/></svg>`,data:l`<svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>`,workspace:l`<svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg>`,automation:l`<svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>`,remote:l`<svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>`,browser:l`<svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>`,ui:l`<svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/></svg>`,experiments:l`<svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M9 3h6v7l4.6 7.7A1 1 0 0 1 18.7 19H5.3a1 1 0 0 1-.9-1.3L9 10z"/><line x1="9" y1="3" x2="15" y2="3"/></svg>`,lifecycle:l`<svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 4 23 10 17 10"/><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"/></svg>`},l0={read:"pi-core",write:"pi-core",edit:"pi-core",bash:"pi-core",powershell:"pi-core",find:"pi-core",grep:"pi-core",ls:"pi-core",list_tools:"internal-tools",activate_tools:"tool-activation",reset_active_tools:"tool-activation",list_scripts:"runtime-scripts",attach_file:"file-attachments",read_attachment:"file-attachments",export_attachment:"file-attachments",get_model_state:"model-control",list_models:"model-control",switch_model:"model-control",switch_thinking:"model-control",messages:"messages-crud",introspect_sql:"sql-introspect",keychain:"keychain-tools",search_workspace:"workspace-search",refresh_workspace_index:"workspace-search",open_office_viewer:"office-viewer",office_read:"office-viewer",office_write:"office-viewer",open_workspace_file:"open-workspace-file",image_process:"image-processing",schedule_task:"scheduled-tasks",scheduled_tasks:"scheduled-tasks",bun_run:"bun-runner",exec_batch:"exec-batch",search_tool_output:"search-tool-output",ssh:"ssh",proxmox:"proxmox",portainer:"portainer",mcp:"mcp",cdp_browser:"cdp-browser",send_adaptive_card:"send-adaptive-card",send_dashboard_widget:"send-dashboard-widget",start_autoresearch:"autoresearch",stop_autoresearch:"autoresearch",autoresearch_status:"autoresearch",exit_process:"exit-process",env:"env-tools"},o0={"read-only":"\uD83D\uDD0D",mutating:"✏️",mixed:"\uD83D\uDD04"},s0=l`<svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg>`});var _u={};_n(_u,{AddonsSection:()=>$0});function $0({setStatus:n,filter:r=""}){let[i,_]=w(null),[c,u]=w(!0),[f,o]=w(null),[s,$]=w(!1),[b,g]=w({runtime:"",windowsNative:!1}),[p,x]=w([]),[v,F]=w([]);function y(){let t=new URLSearchParams;try{let k=(localStorage.getItem("piclaw_addons_catalog_url")||"").trim(),h=(localStorage.getItem("piclaw_addons_catalog_urls")||"").split(/\r?\n/).map((Q)=>Q.trim()).filter(Boolean),L=localStorage.getItem("piclaw_addons_repo_url");if(k)t.append("catalog_url",k);for(let Q of h)t.append("catalog_url",Q);if(L)t.set("repo_url",L)}catch(k){}let H=t.toString();return H?`?${H}`:""}let K=T(async()=>{try{let[t,H]=await Promise.all([fetch(`/agent/addons${y()}`),fetch("/agent/settings-data")]),k=await t.json();if(k.error)throw Error(k.error);_(k.addons||[]),x(k.sources||[]),F(k.failed_sources||[]);let h=await H.json().catch(()=>({})),L=typeof h?.runtimePlatform==="string"?h.runtimePlatform:"";g({runtime:L,windowsNative:L==="win32"})}catch(t){_(null),n?.(String(t.message||t),"error")}finally{u(!1)}},[n]);P(()=>{K()},[]);let W=T(async(t)=>{if(f)return;o({slug:t,action:"install"}),n?.(`Installing ${t}…`,"info");try{let k=await(await fetch(`/agent/addons/install${y()}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({slug:t})})).json();if(k.error){n?.(k.error,"error");return}$(!0);let h=[k.message,k.warning].filter(Boolean).join(" ");n?.(h||"Add-on installed.","success"),await K()}catch(H){n?.(String(H.message||H),"error")}finally{o(null)}},[f,K,n]),N=T(async(t)=>{if(f)return;o({slug:t,action:"remove"}),n?.(`Removing ${t}…`,"info");try{let k=await(await fetch(`/agent/addons/uninstall${y()}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({slug:t})})).json();if(k.error){n?.(k.error,"error");return}$(!0);let h=[k.message,k.warning].filter(Boolean).join(" ");n?.(h||"Add-on removed.","success"),await K()}catch(H){n?.(String(H.message||H),"error")}finally{o(null)}},[f,K,n]),B=T(async()=>{if(f)return;o({slug:null,action:"restart"}),n?.("Restarting piclaw…","info");try{let H=await(await fetch("/agent/addons/restart",{method:"POST"})).json();if(H.error){n?.(H.error,"error"),o(null);return}n?.(H.message||"Restarting piclaw…","success"),$(!1),(async(h=30,L=2000)=>{for(let Q=0;Q<h;Q++){await new Promise((C)=>setTimeout(C,L));try{if((await fetch("/agent/addons",{signal:AbortSignal.timeout(3000)})).ok){await K(),o(null),n?.("Restart complete — add-ons refreshed.","success");return}}catch(C){}}o(null),n?.("Backend did not return in time. Reload the page manually.","warning")})()}catch(t){n?.(String(t.message||t),"error"),o(null)}},[f,n,K]);if(c)return l`<div class="settings-loading">Fetching add-ons\u2026</div>`;if(!i)return l`<div class="settings-section"><p class="settings-hint">Could not load add-ons.</p></div>`;let U=r.toLowerCase(),z=U?i.filter((t)=>t.slug.toLowerCase().includes(U)||(t.description||"").toLowerCase().includes(U)||(t.tags||[]).some((H)=>H.toLowerCase().includes(U))):i,j=f?.slug||null,X=f?f.action==="remove"?`Removing ${f.slug}…`:f.action==="restart"?"Restarting piclaw…":`Installing ${f.slug}…`:"";return l`
        <div class=${`settings-section settings-addon-panel${f?" busy":""}`} aria-busy=${f?"true":"false"}>
            ...
            <div class="settings-addon-list">
                ...
                `}
                ${z.map((t)=>{let H=(t.skills||[]).length>0,k=t.type==="extension",h=H&&k?"extension + skill":H?"skill":"extension",L=H&&!k?"settings-tag-skill":"",Q=typeof t.homepage==="string"&&t.homepage.trim()?t.homepage.trim():"";return l`
                    <div class=${`settings-addon-card${t.installed?" installed":""}`}>
                        <div class="settings-addon-card-header">
                            ...
                            <span class=${`settings-tag settings-tag-type ${L}`}>${h}</span>
    ...
    `}var cu=Y(()=>{m()});var b0={};function di(n,r){try{let i=localStorage.getItem(n);return i===null?r:i==="true"}catch{return r}}function Mr(n,r){try{localStorage.setItem(n,String(r))}catch(i){}}function w0(n,r){try{return localStorage.getItem(n)||r}catch{return r}}function t0(n,r){try{localStorage.setItem(n,r)}catch(i){}}function y0(n,r,i,_){try{return Yn(localStorage.getItem(n),{fallback:r,min:i,max:_})}catch{return Yn(r,{fallback:r,min:i,max:_})}}function h0(n,r){try{localStorage.setItem(n,String(r))}catch(i){}}function x0(){let[n,r]=w(()=>di("piclaw_vim_mode",!1)),[i,_]=w(()=>di("piclaw_show_whitespace",!0)),[c,u]=w(()=>di("piclaw_md_live_preview",!0)),[f,o]=w(()=>y0("piclaw_editor_font_size",13,10,24)),[s,$]=w(()=>w0("piclaw_editor_font_family","")),b=T((g,p,x)=>{let v=!p;x(v),Mr(g,v)},[]);return l`
        <div class="settings-section">
            <h3>Editor</h3>
            <div class="settings-row">
            ...
            <div class="settings-row">
                ...
                <${e}
                    ...
                    fallback=${13}
                    width="70px"
                    onChange=${(g)=>{o(g),h0("piclaw_editor_font_size",g)}}
                />
            </div>
            <div class="settings-row">
    ...
    `}var v0;var uu=Y(()=>{m();rr();Cn();v0=l`<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>`;qn({id:"editor",label:"Editor",icon:v0,component:x0,order:150})});var z0={};function Si(n,r){try{let i=localStorage.getItem(n);return i===null?r:i==="true"}catch{return r}}function ei(n,r){try{localStorage.setItem(n,String(r))}catch(i){}}function mi(n,r){try{return localStorage.getItem(n)||r}catch{return r}}function ai(n,r){try{localStorage.setItem(n,r)}catch(i){}}function p0(){let[n,r]=w(()=>Si("piclaw_dev_mode",!1)),[i,_]=w(()=>mi("piclaw_addons_catalog_url","")),[c,u]=w(()=>mi("piclaw_addons_catalog_urls","")),[f,o]=w(()=>mi("piclaw_addons_repo_url","")),[s,$]=w(()=>Si("piclaw_debug_sse",!1)),[b,g]=w(()=>Si("piclaw_debug_tool_calls",!1)),p=T(()=>{let x=!n;r(x),ei("piclaw_dev_mode",x)},[n]);return l`
        <div class="settings-section">
            <h3>Developer</h3>
            <div class="settings-row">
            ...
            ${n&&l`
                ...
                <div class="settings-row">
                    ...
                    <input type="text" value=${i}
                        onInput=${(x)=>{let v=x.target.value;_(v),ai("piclaw_addons_catalog_url",v)}}
                ...
                <div class="settings-row" style="align-items:flex-start;">
                    ...
                    <textarea
                        value=${c}
                        onInput=${(x)=>{let v=x.target.value;u(v),ai("piclaw_addons_catalog_urls",v)}}
                ...
                <div class="settings-row">
                    ...
                    <input type="text" value=${f}
                        onInput=${(x)=>{let v=x.target.value;o(v),ai("piclaw_addons_repo_url",v)}}
                ...
                <div class="settings-row">
                    ...
                    <input type="checkbox" checked=${s}
                        onChange=${()=>{let x=!s;$(x),ei("piclaw_debug_sse",x)}} />
                </div>
                <div class="settings-row">
                    <label>Log tool calls</label>
                    <input type="checkbox" checked=${b}
                        onChange=${()=>{let x=!b;g(x),ei("piclaw_debug_tool_calls",x)}} />
                </div>
...
`));try{window.__piclawSettingsPerfLog=r}catch(i){}try{fetch("/agent/client-perf",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({label:"settings-dialog",lines:r})}).catch((i)=>{})}catch(i){}$r.length=0}function W0(n){let r=Zr.get(n);if(r)return Promise.resolve(r);let i=qr.get(n);if(i)return i;let _=B0[n]().then((c)=>{return Zr.set(n,c),qr.delete(n),c}).catch((c)=>{throw qr.delete(n),c});return qr.set(n,_),_}function Dr(n="Loading…"){return l`
    ...
    `}function Ir({onClose:n}){wr("SettingsDialogContent-render-start");let[r,i]=w(()=>ui()||"general"),[_,c]=w(lu),[u,f]=w(null),[o,s]=w(""),[,$]=w(0),[b,g]=w(()=>Object.fromEntries(Zr.entries())),[p,x]=w(null),[v,F]=w({compact:!1,narrow:!1}),y=Z(null),K=Z(null);P(()=>{wr("SettingsDialogContent-mounted"),F0()},[]),P(()=>{let h=(L)=>{if(L.key==="Escape")n()};return window.addEventListener("keydown",h),()=>window.removeEventListener("keydown",h)},[n]),P(()=>{let h=(L)=>{let Q=typeof L?.detail?.section==="string"?L.detail.section.trim():"";if(Q)i(Q),s("")};return window.addEventListener("piclaw:open-settings",h),()=>window.removeEventListener("piclaw:open-settings",h)},[]),P(()=>{let h=()=>$((L)=>L+1);return window.addEventListener("piclaw:settings-panes-changed",h),()=>window.removeEventListener("piclaw:settings-panes-changed",h)},[]),P(()=>{fetch("/agent/settings-data").then((h)=>h.json()).then((h)=>{lu=h,c(h)}).catch(()=>c({}))},[]),P(()=>{let h=K.current;if(!h)return;let L=()=>{let Q=h.clientWidth||0;F((C)=>{let O={compact:Q>0&&Q<=860,narrow:Q>0&&Q<=720};return C.compact===O.compact&&C.narrow===O.narrow?C:O})};if(L(),typeof ResizeObserver==="function"){let Q=new ResizeObserver(()=>L());return Q.observe(h),()=>Q.disconnect()}return window.addEventListener("resize",L),()=>window.removeEventListener("resize",L)},[]);let W=[...su].sort((h,L)=>(h.order??500)-(L.order??500)),B=H_().map((h)=>({id:h.id,label:h.label,icon:h.icon,searchable:h.searchable||!1,placeholder:h.searchPlaceholder,order:h.order??500,isExtension:!0,component:h.component})).sort(ci),U=[...W,...B],z=U.find((h)=>h.id===r)||su.find((h)=>h.id===r);P(()=>{if(z?.searchable)requestAnimationFrame(()=>y.current?.focus())},[r]),P(()=>{if(z?.isExtension){x(null);return}let h=!1;if(b[r]){x(null);return}return x(r),W0(r).then((L)=>{if(h)return;g((Q)=>Q?.[r]?Q:{...Q||{},[r]:L})}).catch((L)=>{if(h)return;console.error(`[settings-dialog] Failed to lazy-load section "${r}".`,L)}).finally(()=>{if(!h)x((L)=>L===r?null:L)}),()=>{h=!0}},[r,z?.isExtension,b]);let j=T((h,L="info")=>{f(h?{text:h,type:L}:null)},[]),X=T((h)=>{i(h),s("");let L=k0[h];if(L&&!ou.has(h))ou.add(h),L().then(()=>$((Q)=>Q+1)).catch((Q)=>{})},[]),t=T((h)=>{c((L)=>({...L||{},...h||{}}))},[]),H=()=>{if(z?.isExtension){if(!z.component)return Dr("Loading pane…");let L=z.component;return l`<${L} filter=${o} />`}let h=b[r];if(!h||p===r)return Dr(`Loading ${z?.label||"settings"}…`);switch(r){case"general":return l`<${h} settingsData=${_} setStatus=${j} mergeSettingsData=${t} />`;case"sessions":return l`<${h} settingsData=${_} setStatus=${j} mergeSettingsData=${t} />`;case"recordings":return l`<${h} filter=${o} setStatus=${j} />`;case"compaction":return l`<${h} settingsData=${_} setStatus=${j} mergeSettingsData=${t} />`;case"keyboard":return l`<${h} filter=${o} setStatus=${j} />`;case"workspace":return l`<${h} settingsData=${_} setStatus=${j} mergeSettingsData=${t} />`;case"environment":return l`<${h} settingsData=${_} filter=${o} setStatus=${j} mergeSettingsData=${t} />`;case"providers":return l`<${h} providers=${_?.providers} setStatus=${j} />`;case"models":return l`<${h} filter=${o} />`;case"theme":return l`<${h} themes=${_?.themes} colorKeys=${_?.colorKeys} settingsData=${_} setStatus=${j} mergeSettingsData=${t} />`;case"scheduled-tasks":return l`<${h} filter=${o} setStatus=${j} />`;case"quick-actions":return l`<${h} filter=${o} setStatus=${j} mergeSettingsData=${t} />`;case"keychain":return l`<${h} filter=${o} />`;case"tools":return l`<${h} toolsets=${_?.toolsets} filter=${o} settingsData=${_} mergeSettingsData=${t} />`;case"addons":return l`<${h} setStatus=${j} filter=${o} />`;default:return Dr("Loading settings…")}},k=!z;return wr("SettingsDialogContent-render-end"),l`
            ...
            <div ref=${K} data-testid="settings-dialog" class=${`settings-dialog${v.compact?" settings-dialog-compact":""}${v.narrow?" settings-dialog-narrow":""}`}>
                ...
                <div class="settings-dialog-body">
                    <nav class="settings-nav">
                        ${U.map((h,L)=>{let Q=L>0&&!U[L-1].isExtension,C=h.isExtension&&Q;return l`
                                ${C&&l`<div class="settings-nav-separator"></div>`}
                                <button class=${`settings-nav-item ${h.id===r?"active":""}`} onClick=${()=>X(h.id)}>
...
//# debugId=E81C70C8111B619D64756E2164756E21
