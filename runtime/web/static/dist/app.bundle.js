...
(() => {
  ...
  function L(n2, l2, u3, t2, i3, r2, o2, e2, f3, c2, s2) {
    ...
    for (f3 = T(u3, l2, m2, f3, b2), a2 = 0; a2 < b2; a2++) null != (p2 = u3.__k[a2]) && (h2 = -1 != p2.__i && m2[p2.__i] || d, p2.__i = a2, _2 = q(n2, p2, h2, i3, r2, o2, e2, f3, c2, s2), v2 = p2.__e, p2.ref && h2.ref != p2.ref && (h2.ref && J(h2.ref, null, p2), s2.push(p2.ref, p2.__c || v2, p2)), null == y2 && null != v2 && (y2 = v2), (g2 = !!(4 & p2.__u)) || h2.__k === p2.__k ? (f3 = j(p2, f3, n2, g2), g2 && h2.__e && (h2.__e = null)) : "function" == typeof p2.type && void 0 !== _2 ? f3 = _2 : v2 && (f3 = v2.nextSibling), p2.__u &= -7);
    return u3.__e = y2, f3;
  }
  ...
  function q(n2, u3, t2, i3, r2, o2, e2, f3, c2, s2) {
    ...
    else null == o2 && u3.__v == t2.__v ? (u3.__k = t2.__k, u3.__e = t2.__e) : f3 = u3.__e = G(t2.__e, u3, t2, i3, r2, o2, e2, c2, s2);
  ...
  function G(u3, t2, i3, r2, o2, e2, f3, c2, s2) {
    ...
    if (null == x2) m2 === k2 || c2 && u3.data == k2 || (u3.data = k2);
      ...
      else if (p2 && (u3.innerHTML = ""), L("template" == t2.type ? u3.content : u3, g(v2) ? v2 : [v2], t2, i3, r2, "foreignObject" == x2 ? "http://www.w3.org/1999/xhtml" : o2, e2, f3, e2 ? e2[0] : i3.__k && $(i3, 0), c2, s2), null != e2) for (a2 = e2.length; a2--; ) b(e2[a2]);
  ...
  function App() {
    return /* @__PURE__ */ u2(
      "div",
      {
        ...
        children: /* @__PURE__ */ u2("div", { style: { display: "grid", gap: "12px" }, children: items.map((item) => /* @__PURE__ */ u2(
          "div",
          {
            style: { alignItems: "center", display: "flex", gap: "8px" },
            children: [
              /* @__PURE__ */ u2(Icon, { name: item.name }),
