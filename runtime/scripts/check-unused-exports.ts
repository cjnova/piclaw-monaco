...
const ALLOWED_UNUSED_EXPORTS = new Set([
  ...
  "src/channels/web/http/extension-routes.ts - getTreeWidgetHtmlProvider",
  ...
  "src/db/remote-interop.ts - getPairRequestById",
  "src/db/remote-interop.ts - getPendingPairRequests",
  "src/db/remote-interop.ts - createOutboundPairRequest",
  "src/db/remote-interop.ts - getPendingRemoteRequests",
  "src/db/remote-interop.ts - getAllRemoteRequests",
  "src/db/remote-interop.ts - countRemoteRequests",
  ...
  "src/remote/service-security.ts - verifyCallbackProof",
  ...
  "src/addons/runtime-contributions.ts:186 - resetAddonRuntimeContributionsForTests",
  "src/agent-memory/daily-notes.ts:7 - DAILY_NOTES_DIR",
  "src/agent-pool/branch-seeding.ts:290 - readDeferredBranchSeed",
  "src/agent-pool/branch-seeding.ts:321 - clearDeferredBranchSeed",
  "src/agent-pool/provider-usage.ts:303 - getProviderUsage",
  "src/channels/web/handlers/addon-config-api.ts:207 - getRegisteredAddonConfigApis",
  "src/channels/web/handlers/addon-config-api.ts:216 - resetAddonConfigApiRegistryForTests",
  "src/channels/web/handlers/addons.ts:40 - setAddonInstallTestHooksForTests",
  "src/channels/web/http/extension-routes.ts:54 - isExtensionRouteRegistryFrozen",
  "src/channels/web/timeline-service.ts:115 - SearchFilter",
  "src/channels/web/workspace/constants.ts:33 - MAX_UPLOAD_BYTES",
  "src/channels/web/workspace/paths.ts:46 - resolveExistingWorkspacePath",
  "src/db.ts:109 - endChatRunWithError",
  "src/db.ts:22 - previewPermanentDeleteArchivedBranch",
  "src/db.ts:92 - extensionKvDeleteByChatJid",
  "src/db.ts:93 - extensionKvPrune",
  "src/db.ts:95 - KvScope",
  "src/db.ts:96 - KvEntry",
  "src/db.ts:97 - KvQueryOptions",
  "src/db/media-compression.ts:93 - isCompressed",
  "src/db/remote-interop.ts:307 - getPendingOutboundPairRequest",
  "src/extension-kv-registry.ts:88 - getExtensionKvStore",
  "src/extensions/azure-openai-api.ts:291 - resolveCacheSessionId",
  "src/extensions/azure-openai-api.ts:298 - applySessionCorrelationHeaders",
  "src/extensions/request-batch.ts:157 - writeRequestOutputFile",
  "src/extensions/request-batch.ts:173 - appendOutputFileNote",
  "src/extensions/request-batch.ts:178 - runRequestBatch",
  "src/extensions/session-status.ts:103 - removeSession",
  "src/extensions/structured-tool-response.ts:44 - presentStructuredToolValue",
  "src/router.ts:34 - escapeXml",
  "src/runtime/progress-watchdog-supervisor.ts:178 - setProgressWatchdogMonitorSpawnForTests",
  "src/runtime/progress-watchdog-supervisor.ts:182 - setProgressWatchdogSupervisorEnvironmentForTests",
  "src/runtime/progress-watchdog-supervisor.ts:196 - resetProgressWatchdogSupervisorForTests",
  "src/runtime/progress-watchdog.ts:126 - setProgressWatchdogTimeoutForTests",
  "src/runtime/progress-watchdog.ts:258 - setProgressWatchdogTerminationHook",
  "src/runtime/progress-watchdog.ts:270 - resetProgressWatchdogForTests",
  "src/runtime/provider-bootstrap.ts:56 - setProviderBootstrapLoaderForTests",
  "src/runtime/provider-bootstrap.ts:62 - resetProviderBootstrapForTests",
  "src/secure/keychain-providers.ts:102 - clearKeychainProviders",
  "src/secure/keychain-providers.ts:73 - registerKeychainProvider",
  "src/secure/keychain-providers.ts:88 - unregisterKeychainProvider",
  "src/secure/keychain-providers.ts:97 - getRegisteredKeychainProviders",
  "src/secure/keychain.ts:384 - isInjectableKeychainEnvName",
  "src/types.ts:167 - ProxmoxConfigSetResult",
  "src/types.ts:173 - ProxmoxConfigClearResult",
  "src/types.ts:195 - PortainerConfigSetResult",
  "src/types.ts:201 - PortainerConfigClearResult",
  "src/workspace-search.ts:440 - setBackgroundWorkspaceIndexRefreshRequesterForTests",
]);
